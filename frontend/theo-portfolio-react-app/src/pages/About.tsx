export default function About() {
    return (
      <div className="container">
        <h1>About Me</h1>
        <img
          src="/images/theobabbitprofilepic.jpeg"
          alt="Profile"
          style={{ width: "250px", borderRadius: "8px", marginBottom: "20px" }}
        />
        <p>
        <p>
          Hello! I am a senior at Northeastern studying Journalism and International Affairs. I graduate in August 2025 and am currently seeking full- or part-time positions in San Diego (or remote) that pair well with my broad range of editorial, communications and reporting experience.
        </p><p><br/>
